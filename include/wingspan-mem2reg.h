#if !defined(WINGSPAN_MEM2REG_H_)
#define WINGSPAN_MEM2REG_H_
...
namespace ws {
	class WingspanMem2Reg : public llvm::PassInfoMixin<WingspanMem2Reg> {
	public:
		//The function we MUST override in order to implement the pass.
		llvm::PreservedAnalyses run(llvm::Function& f, llvm::FunctionAnalysisManager& fam);
		
		//Just an aux; for easier plugin registration.
		static inline constexpr llvm::StringRef name() { return "wingspan-mem2reg"; }
	private:
		//Constructor
		friend class llvm::PassInfoMixin<WingspanMem2Reg>;
