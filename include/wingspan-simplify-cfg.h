#if !defined(WINGSPAN_SIMPLIFY_CFG_H_)
#define WINGSPAN_SIMPLIFY_CFG_H_
...
namespace ws {
	class WingspanCFGSimplifier : public llvm::PassInfoMixin<WingspanCFGSimplifier> {
	public:
		//The function we MUST override in order to implement the pass.
		llvm::PreservedAnalyses run(llvm::Function& f, llvm::FunctionAnalysisManager& fam);

		//Just an aux; for easier plugin registration.
		static inline constexpr llvm::StringRef name() { return "wingspan-simplify-cfg"; }
	private:
		//Constructor
		friend class llvm::PassInfoMixin<WingspanCFGSimplifier>;
